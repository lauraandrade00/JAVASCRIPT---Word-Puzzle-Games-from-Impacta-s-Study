...
var hardGames = [
    ...
    { img: 'img/monkeysSilhouette.png', color:'#ffc48b', word: 'monkey', sound: 'sounds/monkey' },
    ...
    { img: 'img/parrotsSilhouette.png', color:'#ff5f09', word: 'parrot', sound: 'sounds/parrot' },
    { img: 'img/crowsSilhouette.png', color:'#c81f27', word: 'crow', sound: 'sounds/rabe' },
    { img: 'img/cowsSilhouette.png', color:'#b3eef4', word: 'cow', sound: 'sounds/cow' },
    { img: 'img/dolphinsSilhouette.png', color:'#d5ea86', word: 'dolphin', sound: 'sounds/dolphin' },
    { img: 'img/lionsSilhouette.png', color:'#dd992d', word: 'lion', sound: 'sounds/lion' },
    { img: 'img/wolfsSilhouette.png', color:'#dd992d', word: 'wolf', sound: 'sounds/wolf' },
    { img: 'img/pandasSilhouette.png', color:'#dd992d', word: 'panda', sound: 'sounds/panda' },
    { img: 'img/catsSilhouette.png', color:'#dd992d', word: 'cat', sound: 'sounds/meow' },
    { img: 'img/puppysSilhouette.png', color:'#dd992d', word: 'puppy', sound: 'sounds/puppy' },
    { img: 'img/roostersSilhouette.png', color:'#dd992d', word: 'rooster', sound: 'sounds/rooster' },
    { img: 'img/gorillasSilhouette.png', color:'#176580', word: 'gorilla', sound: 'sounds/gorilla' },
    { img: 'img/foxsSilhouette.png', color:'#dd992d', word: 'fox', sound: 'sounds/fox' },
    { img: 'img/sheepsSilhouette.png', color:'#dd992d', word: 'sheep', sound: 'sounds/schafe' },
    { img: 'img/ducksSilhouette.png', color:'#dd992d', word: 'duck', sound: 'sounds/duck' },
    { img: 'img/seagullsSilhouette.png', color:'#dd992d', word: 'seagull', sound: 'sounds/seagull' },
    { img: 'img/rhinocerossSilhouette.png', color:'#dd992d', word: 'rhinoceros', sound: 'sounds/rhinoceros' }
];
